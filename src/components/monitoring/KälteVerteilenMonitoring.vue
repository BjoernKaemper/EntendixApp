      ...
      for (const komponente in this.anlage) {
        ...
        */
        ...
        if (semanticId === 'https://th-koeln.de/gart/ComponentRefrigerationCircuitGeneralAAS/1/0') {
          ...
          semanticId === 'https://th-koeln.de/gart/ComponentRefrigerationMachineConnectionAAS/1/0'
        ) {
          ...
          semanticId === 'https://th-koeln.de/gart/ComponentCirculatingAirCoolingUnitAAS/1/0'
        ) {
