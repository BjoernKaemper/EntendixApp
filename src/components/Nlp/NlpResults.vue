    ...
    <v-container v-if="parentAasIdShort == $route.params.buildingid">
      <v-row>
        <v-col v-for="grundfunktion in this.numberGrundfunktionen" :key="grundfunktion" cols="6">
          <v-card
            max-width="70%"
            v-if="grundfunktion === 'WaermeVersorgen'"
            class="mx-auto my-8"
            elevation="0"
          >
          ...
          <v-card
            max-width="70%"
            v-else-if="grundfunktion === 'LuftVersorgen'"
            class="mx-auto my-8"
            elevation="0"
          >
          ...
          <v-card
            max-width="70%"
            v-else-if="grundfunktion === 'KaelteVersorgen'"
            class="mx-auto my-8"
            elevation="0"
          >
          ...
          <v-card
            max-width="70%"
            v-else-if="grundfunktion === 'MedienVersorgen'"
            class="mx-auto my-8"
            elevation="0"
          >
          ...
          <v-card
            max-width="70%"
            v-else-if="grundfunktion === 'Sichern'"
            class="mx-auto my-8"
            elevation="0"
          >
          ...
          <v-card
            max-width="70%"
            v-else-if="grundfunktion === 'StromVersorgen'"
            class="mx-auto my-8"
            elevation="0"
          >
