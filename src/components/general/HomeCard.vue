            ...
            <v-card-text>
                <v-row v-for="product in products" :key="product.title">
                    ...
                    <v-col cols = "8">
                        ...
                        <v-btn variant="outlined" color="#3B5249" size="small"
                            :icon= product.icon
    ...
    computed: {
        ...
        products () {
            const products = [
                ...
                { image: Object.values(import.meta.glob('@/assets/digital_twin_4.png', {as:'url', eager:true}))[0], icon: 'mdi-home', title: 'Digital Twins', link: '/digitaltwins', text: 'Zur Verwaltung der digitalen Zwillinge Ihrer Liegenschaften' },
                { image: Object.values(import.meta.glob('@/assets/monitoring_golden.png',{as:'url', eager:true}))[0], icon: 'mdi-chart-line', title: 'Monitoring', link: '/monitoring', text:"Zum technischen Monitoring Ihrer Gebäude" }, //vorher link:buildingperformance
            ]
            return products
        },
    }
